...
player = createSprite(displayWidth/2-200,displayHeight/2,10,20);
player.addImage(playerImg);
key1=createSprite(displayWidth/2-450,displayHeight/2-320,10,10);
dog1=createSprite(displayWidth/2+20,displayHeight/2,20,20);
dog1.shapeColor="black";
dog1.addImage(dog)
dog1.velocityX=3.1;
dog2=createSprite(displayWidth/2-450,displayHeight/2-60,20,20);
dog2.addImage(dog)
dog2.velocityX=3.2;
dog3=createSprite(displayWidth/2-450,displayHeight/2-200,20,20);
dog3.addImage(dog);
dog3.velocityX=3.5;
dog4=createSprite(displayWidth/2-200,displayHeight/2+200,20,20);
dog4.addImage(dog);
dog4.velocityX=3.65;
dog4.velocityY=2.1;
door=createSprite(displayWidth/2+40,displayHeight/2+300,20,20);
door.addImage(door1)
key1.addImage(keyimg);
key1.scale=0.5;
key2=createSprite(displayWidth/2-450,displayHeight/2+320,10,10);
...
text("TIME:"+time,displayWidth/2-200,displayHeight/2-200)
  ...
  textSize(20)
  text("GAMEOVER!",displayWidth/2-200,displayHeight/2)
  player.velocityX=0;
  player.velocityY=0;
  dog1.velocityX=0;
  dog2.velocityX=0;
